...
Summary(pl):	JasPer - zestaw oprogramowania do obrСbki obrazkСw
Name:		jasper
Version:	1.500.3
Release:	1
License:	BSD-like
...
i obrСbki obrazkСw w rС©nych formatach. Jednym z nich jest JPEG-2000
zdefiniowany w ISO/IEC 15444-1:2000 (JasPer zawiera tylko czЙ╤ciow╠
implementacjЙ tego formatu).

%package devel
Summary:	JasPer - header files
Summary(pl):	JasPer - pliki nagЁСwkowe
...
Pliki nagЁСwkowe potrzebne do linkowana z libjasper.
