...
Summary(pl):	JasPer - zestaw oprogramowania do obrÛbki obrazkÛw
Name:		jasper
Version:	1.500.3
Release:	1
License:	BSD-like
...
i obrÛbki obrazkÛw w rÛønych formatach. Jednym z nich jest JPEG-2000
zdefiniowany w ISO/IEC 15444-1:2000 (JasPer zawiera tylko czÍ∂ciow±
implementacjÍ tego formatu).

%package devel
Summary:	JasPer - header files
Summary(pl):	JasPer - pliki nag≥Ûwkowe
...
Pliki nag≥Ûwkowe potrzebne do linkowana z libjasper.
